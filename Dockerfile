...
RUN curl -L -o /opt/spark/jars/hadoop-aws-3.3.4.jar https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-aws/3.3.4/hadoop-aws-3.3.4.jar && \
    ...
    curl -L -o /opt/spark/jars/clickhouse-jdbc-0.6.3-all.jar https://repo1.maven.org/maven2/com/clickhouse/clickhouse-jdbc-all/0.6.3/clickhouse-jdbc-all-0.6.3.jar
